...
import {CalendarWithCheck} from '@/components/pictograms';

interface ApprovedScheduleNoteProps {
  currentDate: Date;
}

export const ApprovedScheduleNote = ({
  currentDate,
}: ApprovedScheduleNoteProps) => {
  return (
    <ShadowView
      level={6}
      style={[
      ...
      <View style={[layoutStyles.row, layoutStyles.fullWidth]}>
        <View
          ...
          <CalendarWithCheck height={32} width={32} />
          <View style={[layoutStyles.cover]}>
            ...
            <Typography
              ...
              label="Your work schedule has been approved."
              style={[
                {
                  marginLeft: spacer(12),
                  marginTop: spacer(8),
