...
export const QRWrongSlotModal: ModalComponentWithOptions<
  ModalComponentProp<ModalStackParamsList, void, 'QRWrongSlotModal'>
    ...
    <BaseModal>
      ...
      <View
        ...
        <View
          ...
          <Typography
            align="center"
            label="Oops, you didn’t reserve this slot."
            variant="h3"
