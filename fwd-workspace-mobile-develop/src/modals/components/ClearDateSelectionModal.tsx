...
export const ClearDateSelectionModal: ModalComponentWithOptions<
  ModalComponentProp<ModalStackParamsList, void, 'ClearDateSelectionModal'>
> = ({modal: {closeModal, getParam}}) => {
  ...
  const selectionType = getParam('selectionType');
    ...
    <BaseModal>
      ...
      <View
        ...
        <View
          ...
          <Typography
            align="center"
            label={`Are you sure you want to clear ${selectionType} dates?`}
            variant="h3"
        ...
        <View
          ...
          <Button
            label={`Yes, clear ${
              selectionType === 'all' ? selectionType : 'selection'
            }`}
            mode="outlined"
            onPress={onYesPress}
          />
